...
public class PageStatusFactory {
        ...
        if (pageStatus == null) {
            ...
            Map<String, Object> attributes = Maps.filterKeys(parameters, new Predicate<String>() {
                ...
                public boolean apply(String input) {
                    return !ArrayUtils.contains(ignoreParameters, input);
                }
            });
    ...
    private PageStatus initPageableValueFromServletRequest(HttpServletRequest request, String prefix, String separator) {
        PageStatus pageStatus = createFromDefaultConfig();

        ServletRequestParameterPropertyValues propertyValues = new ServletRequestParameterPropertyValues(request, prefix, separator);
    ...
    private String createQueryString(Map<String, Object> attributes, String[] ignoreFields) {
        ...
        for (Entry<String, Object> entry : attributes.entrySet()) {
            if (!ArrayUtils.contains(ignoreFields, entry.getKey())) {
